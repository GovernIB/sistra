...
/* Establecer PKs */
update BTE_PROAPL set TAP_CODIGO = nextval('BTE_SEQPRO');
commit;
alter table BTE_PROAPL alter column TAP_CODIGO set not null;
alter table BTE_PROAPL add constraint BTE_TAP_PK primary key (TAP_CODIGO);

/* BTE_TRAPRO */
alter table BTE_TRAPRO drop constraint BTE_PRO_PK;
alter table BTE_TRAPRO add  PRO_CODPRO  bigint;
...
commit;
alter table BTE_TRAPRO alter column PRO_CODPRO set not null;
...
/* BTE_FUEDAT */
alter table BTE_FUEDAT add  FUE_CODPRO bigint;
...
commit;
alter table BTE_FUEDAT alter column FUE_CODPRO set not null;
...
/* BTE_TRAMIT  */
alter table BTE_TRAMIT add TRA_CODPRO  bigint;
...
commit;
alter table BTE_TRAMIT alter column TRA_CODPRO set not null;
...
alter table BTE_GESPRO add  GAP_CODPRO bigint;
...
commit;
alter table BTE_GESPRO alter column GAP_CODPRO set not null;
