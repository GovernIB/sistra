...
/* ORGANISMO GENERICO */
INSERT INTO STR_ORGRES (ORG_CODIGO, ORG_DESC) VALUES (STR_SEQORG.NEXTVAL,'GE-Genérico');
...
STR_SEQDOM.NEXTVAL, 'GESACARBUA', 'S', 'es.caib.sistra.db', 'select ''1'' codigo, null parent, ''Unidad Test'' descripcion from dual'
, NULL, 'L', 'N', NULL, NULL, 'N', 1, 'Arbol unidadades administrativas');

INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GESACUADES', 'S', 'es.caib.sistra.db', 'SELECT  ''1'' CODIGO,''Unidad Test'' DESCRIPCION  FROM dual WHERE ''XX'' <> ?'
, NULL, 'L', 'N', NULL, NULL, 'N', 1, 'Descripción de unidad administrativa. Parametrizado por código unidad.'); 

INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GESACUNADM', 'S', 'es.caib.sistra.db', 'SELECT  ''1'' CODIGO,''Unidad Test'' DESCRIPCION  FROM dual'
, NULL, 'L', 'N', NULL, NULL, 'N', 1, 'Lista de unidades administrativas'); 

/* 	DOMINIOS ESTRUCTURA RDS */
INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GERDSMODE', 'S', 'es.caib.redose.db', 'SELECT 	MOD_MODELO CODIGO,MOD_MODELO || '' - '' || MOD_NOMBRE DESCRIPCION FROM RDS_MODELO ORDER BY 1'
, NULL, 'L', 'N', NULL, NULL, 'N', 1, 'Lista de modelos de documentos del RDS'); 

INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GERDSVERS', 'S', 'es.caib.redose.db', 'SELECT RDS_VERS.VER_VERSIO CODIGO, TO_CHAR(RDS_VERS.VER_VERSIO) DESCRIPCION FROM RDS_VERS,RDS_MODELO WHERE RDS_MODELO.MOD_CODIGO =  RDS_VERS.VER_CODMOD AND RDS_MODELO.MOD_MODELO = ? ORDER BY 1'
...
INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GEFORMMODE', 'S', 'es.caib.rolforms.db', 'SELECT DISTINCT RFR_FORMUL.FOR_MODELO CODIGO,RFR_FORMUL.FOR_MODELO || '' - '' || RFR_TRAFOR.TRF_TITULO DESCRIPCION
...
INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GEFORMMOVE', 'S', 'es.caib.rolforms.db', 'SELECT RFR_FORMUL.FOR_MODELO MODELO,
...
INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GEFORMVERS', 'S', 'es.caib.rolforms.db', 'SELECT  RFR_FORMUL.FOR_VERSIO CODIGO, RFR_FORMUL.FOR_VERSIO DESCRIPCION 
FROM RFR_FORMUL 
...
INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GEPAISES', 'S', 'es.caib.sistra.db', 'SELECT TRIM( PAI_CODALF ) CODIGO, UPPER( PAI_DENCAS ) DESCRIPCION FROM STR_DPAIS WHERE PAI_VIGENC = ''S'' ORDER BY DESCRIPCION'
, NULL, 'L', 'N', NULL, NULL, 'N', 1, 'Lista de paises'); 

INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GEPROVINCI', 'S', 'es.caib.sistra.db', 'SELECT PRO_CODIGO CODIGO, PRO_DENCAT DESCRIPCION FROM STR_DPROVI ORDER BY CODIGO'
, NULL, 'L', 'N', NULL, NULL, 'N', 1, 'Lista de provincias'); 

INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GEGMUNICI', 'S', 'es.caib.sistra.db', 'SELECT MUN_CODIGO CODIGO, MUN_DENOFI DESCRIPCION FROM STR_DMUNIC WHERE MUN_PROVIN = ? ORDER BY DESCRIPCION'
, NULL, 'L', 'N', NULL, NULL, 'N', 1, 'Lista de municipios de una provincia. Parametrizado por código provincia.'); 

INSERT INTO STR_DOMIN ( DOM_CODIGO, DOM_IDENTI, DOM_TIPO, DOM_URL, DOM_SQL, DOM_JNDI, DOM_EJBREM,
DOM_EJBSTD, DOM_USR, DOM_PWD, DOM_CACHE, DOM_CODORG, DOM_DESC ) VALUES ( 
STR_SEQDOM.NEXTVAL, 'GEMUNIDESC', 'S', 'es.caib.sistra.db', 'SELECT MUN_CODIGO CODIGO, MUN_DENOFI DESCRIPCION FROM STR_DMUNIC WHERE MUN_PROVIN = ? AND MUN_CODIGO = ?'
