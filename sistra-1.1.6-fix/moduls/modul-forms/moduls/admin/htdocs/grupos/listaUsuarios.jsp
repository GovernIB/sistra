...
<html:xhtml/>
	...
	<!--
	 ...
	 function asignarUsuario(){
	   ...
	   if(usuario!=null && usuario!=''){
		   ...
		   $.getJSON("asociarUsuario.do", { usuario: usuario, formulario : formulario},function(datos){
	...
	function eliminar(idUser){
	   	...
	   	var flag = "eliminar";
	   	$.ajaxSetup({scriptCharset: "utf-8" , contentType: "application/json; charset=utf-8"}); 
	   	$.getJSON("asociarUsuario.do", { usuario: idUser, formulario : formulario, flag: flag },function(datos){
			$('#datosUsuarios').html(datos.taula);
		});
	}
	//-->
...
<table class="marc">
    <tr>
    	...
    	<td class="input">
			<html:text styleClass="textUser" name="formularioForm" property="usuario" styleId="usuario" />				    
