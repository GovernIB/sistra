                ...
                <logic:present name="<%=bean%>" property="values.identificador">                	
                	<logic:notPresent name="bloqueado">
	                    ...
	                    <bean:define id="mensajeBaja"><bean:message key='messatge.baja' /></bean:define>                                                           
		                    <logic:notPresent name="<%=bean%>" property="tramite.codigo">
		                    	<bean:define id="urlBaja"><html:rewrite page='<%= actionBaja + ".do" %>' paramId="identificador" paramName="<%= bean %>" paramProperty="values.identificador"/></bean:define>
		                    ...
		                    <logic:present name="<%=bean%>" property="tramite.codigo">
		                    	<bean:define id="urlBaja"><html:rewrite page='<%= actionBaja + ".do" %>' paramId="identificador" paramName="<%= bean %>" paramProperty="tramite.identificador"/></bean:define>
		                    	<button class="button" type="button" onclick="confirmAndForward('<%= StringEscapeUtils.escapeJavaScript( mensajeBaja ) %>', '<%=urlBaja%>')"><bean:message key="boton.baixa" /></button>
		                    </logic:present>
				        <%
							}
                    ...
                    <logic:equal name="bean" value="tramiteVersionForm">
	                	<bean:define id="urlExportacion">
	                		<html:rewrite page="/generar/xml.do" paramId="identificador" paramName="<%= bean %>" paramProperty="values.identificador" />
	                	</bean:define>
	                	...
	                	<bean:define id="urlBloquear">
	                		<html:rewrite page="/back/tramiteVersion/bloquear.do" paramId="identificador" paramName="<%= bean %>" paramProperty="values.identificador" />
	                	</bean:define>
...
<logic:present name="<%=bean%>" property="values.identificador">
    ...
    <logic:iterate id="element" name="listaRelaciones">
        <tiles:insert beanName="element" flush="false" >
            <tiles:put name="id" beanName="<%=bean%>" beanProperty="values.identificador" />
        </tiles:insert>
    </logic:iterate>
</logic:present>
