...
public class ObjectFactory {
    ...
    private final static QName _DatosNotificacionFirmaPorClave_QNAME = new QName("", "firmaPorClave");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "firmaPorClave", scope = DatosNotificacion.class)
    public JAXBElement<Boolean> createDatosNotificacionFirmaPorClave(Boolean value) {
        return new JAXBElement<Boolean>(_DatosNotificacionFirmaPorClave_QNAME, Boolean.class, DatosNotificacion.class, value);
    }
