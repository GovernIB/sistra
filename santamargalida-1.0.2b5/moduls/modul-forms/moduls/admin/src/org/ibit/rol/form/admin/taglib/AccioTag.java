package org.ibit.rol.form.admin.taglib;
 ...
 * 
 * <p>El tipus ha d'esser: alta, baixa o modificacio.</p>
...
public class AccioTag extends BaseHandlerTag {
     ...
     * @exception javax.servlet.jsp.JspException Si es produeix una excepci&oacute JSP
     */
    ...
    protected String property(String tipus) throws JspException {
        if ("alta".equals(tipus)) {
            ...
            sb.append("'alta', 'baixa', ò 'modificacio'");
