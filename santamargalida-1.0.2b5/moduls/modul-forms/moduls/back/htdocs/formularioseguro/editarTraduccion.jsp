...
<logic:present name="formularioSeguroForm" property="traduccion.plantilla">
    <tr>
        <td class="label"><bean:message key="formulario.plantilla" /></td>
        <td class="input">
            <bean:define id="lang" name="formularioSeguroForm" property="lang" type="java.lang.String"/>
            <html:link page='<%="/back/formulario/plantilla.do?lang=" + lang%>' paramId="id" paramName="formularioSeguroForm" paramProperty="values.id"><bean:write name="formularioSeguroForm" property="traduccion.plantilla.nombre"/></html:link>
            <%-- <input type="text" name="temp" class="curt" readonly="readonly" value='<bean:write name="formularioSeguroForm" property="traduccion.plantilla.nombre"/>' /> --%>
...
<logic:notPresent name="formularioSeguroForm" property="traduccion.plantilla">
