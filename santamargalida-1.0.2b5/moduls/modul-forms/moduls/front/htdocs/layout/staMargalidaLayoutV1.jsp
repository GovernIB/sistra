...
<html:html xhtml="true">
    <head>
        ...
        <link rel="stylesheet" href="<html:rewrite page='<%=pathIconografia + "/css/stamargalida.css"%>'/>" type="text/css" />
...
--%>
		...
		<!--footer-->
<%
	String idioma = org.ibit.rol.form.front.util.LangUtil.getLang(request);
	if (idioma == null) {
		idioma = "ct";
	} else {
		if (idioma.equals("ca")) {
...
%>
		<div class="footer">
			<div class="interior">
				...
				<ul class="menupeu">
					<li><a href="http://www.ajsantamargalida.net/dadesPeu/avis.<%= idioma %>.html" target="_blank"><bean:message bundle="caibMessages" key="pie.avisoLegal"/></a></li>
					<li><a href="http://www.ajsantamargalida.net/contacte/index.<%= idioma %>.html" target="_blank"><bean:message bundle="caibMessages" key="pie.contacto"/></a></li>
					<li><a href="http://www.ajsantamargalida.net/dadesPeu/proteccio_dades.<%= idioma %>.html" target="_blank"><bean:message bundle="caibMessages" key="pie.proteccion"/></a></li>
				</ul>
				<ul class="accessibilitat">
					<li><a href="http://jigsaw.w3.org/css-validator/check/refererr" target="_blank"><img src="estilo_caib/images/css21.gif" width="66" height="31" alt="CSS 2.1" /></a></li>
					<li><a href="http://validator.w3.org/check?uri=referer" target="_blank"><img src="estilo_caib/images/xhtml10.gif" width="64" height="31" alt="XHTML 1.0" /></a></li>
					<li><a href="http://www.w3.org/WAI/WCAG1AA-Conformance" target="_blank"><img src="estilo_caib/images/wai.gif" width="66" height="31" alt="WAI-AA" /></a></li>
					<li class="rss"><a href="http://www.ajsantamargalida.net/dadesPeu/rss.<%= idioma %>.html" target="_blank"><img src="estilo_caib/images/rss.gif" width="31" height="31" alt="WAI-AA" /><span><bean:message bundle="caibMessages" key="pie.sindicacion" /></span></a></li>
					<% if (org.ibit.rol.form.front.util.Util.permitirDebugScript())  { %>
						<li><input type="button" onclick="obrir('<%=urlLog%>','log',600,600)" value="Debug script" /></li>
					<% } %>	
				</ul>
			</div>
		</div>
