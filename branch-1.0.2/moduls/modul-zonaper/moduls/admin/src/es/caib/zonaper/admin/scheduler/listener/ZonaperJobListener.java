package es.caib.zonaper.admin.scheduler.listener;
...
public class ZonaperJobListener implements JobListener
{
	Log log = LogFactory.getLog( ZonaperJobListener.class );
