package es.caib.mobtratel.ws.interceptor;
...
public class BasicAuthAuthorizationInterceptor extends SoapHeaderInterceptor {
    ...
    protected void initialise(){
         ...
         if (securityDomain != null) {
            try {
               ...
               log.error("Error en el interceptor función initialise " + e.getMessage(),e);
            }
         }
    ...
    @Override public void handleMessage(Message message) throws Fault {
    	...
    	try {
	        ...
	        if (authMgr == null) {
	        	log.error("No hay ningún dominio de seguridad asociado.");
	        	sendErrorResponse(message, HttpURLConnection.HTTP_UNAUTHORIZED);
	            return;
	         }
