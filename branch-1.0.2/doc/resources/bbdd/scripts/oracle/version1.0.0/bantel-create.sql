...
create table BTE_FICEXP  (
   FIC_IDETRA           VARCHAR2(10)                    not null,
...
create table BTE_GESTRA  (
   ...
   GAP_IDETRA           VARCHAR2(10)                    not null
);
...
create table BTE_TRAAPL  (
   TAP_IDETRA           VARCHAR2(10)                    not null,
...
'PARA TIPO DOMINIO EJB INDICA SI EL ACCESO ES AUTENTICADO: SIN AUTENTICAR (N),  FORMA STANDAR ( S ) O CON EL MECANISMO DE AUTENTICACIÓN DE LA CAIB ( C )';
...
create table BTE_TRAMIT  (
   ...
   TRA_FECPRO           DATE,
   TRA_IDETRA           VARCHAR2(10)                    not null,
