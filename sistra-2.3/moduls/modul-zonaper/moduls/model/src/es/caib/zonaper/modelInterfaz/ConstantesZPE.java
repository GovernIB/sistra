...
public class ConstantesZPE {
	...
	/**
	 * CONSULTA ESTADO PAGOS: PAGO REALIZADO.
	 */
	public final static String CONSULTAESTADOPAGOS_PAGO_REALIZADO = "PAGADO";
	/**
	 * CONSULTA ESTADO PAGOS: PAGO PENDIENTE CONFIRMAR.
	 */
	public final static String CONSULTAESTADOPAGOS_PAGO_PENDIENTE_CONFIRMAR = "PENDIENTE_CONFIRMAR";
	/**
	 * CONSULTA ESTADO PAGOS: PAGO NO REALIZADO.
	 */
	public final static String CONSULTAESTADOPAGOS_PAGO_NO_REALIZADO = "NO_PAGADO";
	/**
	 * CONSULTA ESTADO PAGOS: PAGO EXCEDIDO TIEMPO PAGO.
	 */
	public final static String CONSULTAESTADOPAGOS_PAGO_EXCEDIDO_TIEMPO_PAGO = "EXCEDIDO_TIEMPO_PAGO";
	/**
	 * CONSULTA ESTADO PAGOS: TRAMITE PENDIENTE ENVIAR.
	 */
	public final static String CONSULTAESTADOPAGOS_TRAMITE_PENDIENTE_ENVIAR = "PENDIENTE_ENVIAR";
	/**
	 * CONSULTA ESTADO PAGOS: TRAMITE ENVIADO.
	 */
	public final static String CONSULTAESTADOPAGOS_TRAMITE_ENVIADO = "ENVIADO";
	/**
	 * CONSULTA ESTADO PAGOS: TRAMITE NO EXISTE.
	 */
	public final static String CONSULTAESTADOPAGOS_TRAMITE_NO_EXISTE = "NO_EXISTE";
