 ...
 *       &lt;sequence>
 *         &lt;element name="referenciaRDS" type="{urn:es:caib:regtel:ws:v1:model:ReferenciaRDS}ReferenciaRDS" minOccurs="0"/>
 ...
 *         &lt;element name="firmas" type="{urn:es:caib:regtel:ws:v1:model:FirmaWS}FirmasWS" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Documento", namespace = "urn:es:caib:regtel:ws:v1:model:Documento", propOrder = {
    "referenciaRDS",
    "modelo",
    "version",
    "nombre",
