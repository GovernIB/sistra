...
<bean:define id="messageAyuda" value="ayuda.envioMail" />
...
<div id="contenedor">	
	...
	<div class="element">
		<div class="etiqueta"><label for="fechaProgramacion"><bean:message key="editarEnvio.email.mensaje.tipoProgramacion"/></label></div>
		<div class="control">
				<!-- Envio inmediato o programado -->	
				<html:radio property="inmediato" value="S"><bean:message key="editarEnvio.email.mensaje.tipoProgramacion.inmediato"/></html:radio>
