 ...
 *       &lt;sequence>
 *         &lt;element name="realizarConsultaReturn" type="{urn:es:caib:sistra:ws:v2:model:DocumentoConsulta}DocumentosConsulta"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RealizarConsultaResponse {
    ...
    @XmlElement(namespace = "urn:es:caib:sistra:ws:v2:model:SistraFacade", required = true)
