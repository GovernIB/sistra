...
alter table ZPE_RPAGOS  add PAG_LOCPAS           VARCHAR2(200);
alter table ZPE_RPAGOS  add PAG_TOKPAS           VARCHAR2(200);
alter table ZPE_RPAGOS  add PAG_IDAGRU           VARCHAR2(100);
alter table ZPE_RPAGOS  add PAG_DIFERI           VARCHAR2(1) default 'N' not null;
