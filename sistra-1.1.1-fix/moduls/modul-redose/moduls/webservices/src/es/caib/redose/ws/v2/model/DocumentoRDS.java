 ...
 *         &lt;element name="referenciaRDS" type="{urn:es:caib:redose:ws:v2:model:ReferenciaRDS}ReferenciaRDS" minOccurs="0"/>
 *         &lt;element name="firmas" type="{urn:es:caib:redose:ws:v2:model:FirmaWS}FirmasWS" minOccurs="0"/>
...
@XmlType(name = "DocumentoRDS", namespace = "urn:es:caib:redose:ws:v2:model:DocumentoRDS", propOrder = {
    "modelo",
    "version",
    "titulo",
    "nif",
...
public class DocumentoRDS {
    ...
    @XmlElementRef(name = "idioma", type = JAXBElement.class)
