 ...
 * @struts.action
 *  name="pantallaForm"
 *  path="/expresion/autorellenableV1"
 *  scope="request"
 *  validate="false"
 *
 * @struts.action
 *  name="pantallaForm"
 *  path="/auth/expresion/autorellenableV1"
 *  scope="request"
 *  validate="false"
 *
 * @struts.action
 *  name="pantallaForm"
 *  path="/secure/expresion/autorellenableV1"
 *  scope="request"
 *  validate="false"
 *
 * @struts.action
 *  name="pantallaForm"
 *  path="/auth/secure/expresion/autorellenableV1"
 *  scope="request"
 *  validate="false"
 *
 */
public class CalcularAutorellenableActionV1 extends BaseAction {

    protected static Log log = LogFactory.getLog(CalcularAutorellenableActionV1.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        Object result = delegate.expresionAutorellenableCampo(fieldName);
