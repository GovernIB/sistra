...
/**
 * @struts.action
 *  path="/asignarRepresentante"
 * 
 */
public class AsignarRepresentanteAction extends Action
{
	private static Log _log = LogFactory.getLog( AsignarRepresentanteAction.class );
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try{
	 	...
	 	// Indicamos si existe representante activo
