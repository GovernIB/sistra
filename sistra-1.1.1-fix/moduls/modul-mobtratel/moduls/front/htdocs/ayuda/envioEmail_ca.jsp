...
<P class=centrado>En aquesta pàgina pot   donar d'alta un enviament  Email:</P>
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td>Títol del missatge Email (Assumpte) </td>
  </tr>
  <tr>
    <td><strong>Missatge</strong></td>
    <td>Cos del missatge Email. Es de tipus HTML. </td>
  </tr>
  <tr>
