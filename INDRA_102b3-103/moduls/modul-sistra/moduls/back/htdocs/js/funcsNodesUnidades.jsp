...
<logic:iterate id="nodo" name="unidadesadministrativas" type="es.caib.sistra.back.action.tramiteVersion.NodoUnidadAdministrativa">
	...
	<logic:notEmpty name="nodo" property="parentId">
		...
		<bean:write name="nodo" property="id"/>.pospendHTML = '    [<i><a href="javascript:seleccionar(\'<bean:write name='nodo' property='id'/>\');">Seleccionar</a></i>]';
