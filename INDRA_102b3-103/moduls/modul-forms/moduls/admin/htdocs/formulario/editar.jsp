...
<head>
   <title><bean:message key="formulario.editar.title"/></title>
...
<body class="ventana">
<html:form action="/admin/formulario/seleccion.do"  >
<table class="marc">
    <tr><td class="titulo">
            <bean:message key="formulario.editar.title" />
    </td></tr>
</table>
<br />
...
<br />
    ...
    <table class="marc">
		<tr>
		    ...
		    <td class="label"><bean:message key="formulario.modelo"/></td>
		    <td class="output">
		...
		<tr>
		    ...
		    <td class="output">
		    	<bean:write name="formulario" property="version"/>
		    </td>

		</tr>
		<tr>
		    <td class="label"><bean:message key="formulario.titulo"/></td>
		    <td class="output">
    ...
    <table class="nomarc">
       <tr>
            <td align="left">
	            <button class="buttond" type="button" onclick="forward('<html:rewrite page="/admin/formulario/lista.do"/>')">
