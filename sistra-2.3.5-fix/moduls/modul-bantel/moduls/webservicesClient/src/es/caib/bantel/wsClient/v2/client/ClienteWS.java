...
public class ClienteWS {
	...
	public static void avisarEntradasWS(List entradas, String url,String soapAction, String user, String pass, boolean async) throws Exception{
		...
		try {
			es.caib.bantel.wsClient.v2.services.BantelFacade port = generarPort(url,soapAction,user,pass);
	...
	private static es.caib.bantel.wsClient.v2.services.BantelFacade generarPort(String url,String soapAction,String user,String pass) throws Exception{
