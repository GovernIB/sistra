...
<object id="appfirma" name="appfirma" classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" width="230" height="35">
	...
	<param name="archive" value="signaturacaib.core-3.3.2-api-unsigned.jar,appletFirma.jar" />
	...
	<comment>
		...
		archive="signaturacaib.core-3.3.2-api-unsigned.jar,appletFirma.jar"		
		idioma="es"
		id="appfirma2"
		scriptable="true"
		useAlwaysDefaultContentType="<%= isAlwaysDefaultContentTypeForSignature%>">
			<noembed>
				No te suport per applets Java 2 SDK, Standard Edition ! !
			</noembed>
		</embed>		
	</comment>
</object>