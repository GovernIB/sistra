...
create table STR_DOCNIV  (
   ...
   DNV_OBLIGA           VARCHAR(1)                     not null,
   DNV_OBLSCR          BYTEA,
   DNV_FIRMAR           VARCHAR(1)                     not null,
   DNV_FIRMTE           VARCHAR(500),
   DNV_FORGST           VARCHAR(20)                   default 'forms' not null,
   DNV_FORINI          BYTEA,
   ...
   DNV_FORPLA          BYTEA,
   DNV_PAGDAT          BYTEA,
   DNV_PAGTIP           VARCHAR(1)                    default 'A' not null,
   DNV_FLUTRA          BYTEA,
...
create table STR_DOCUM  (
   ...
   DOC_TIPO             VARCHAR(1)                     not null,
   DOC_ORDEN            BIGINT                       not null,
   DOC_PAD              BIGINT,
   DOC_MODELO           VARCHAR(20)                    not null,
   DOC_FORPRG           VARCHAR(1),
   DOC_FORJUS           VARCHAR(1)                     default 'N',
   DOC_ANEEXT           VARCHAR(50),
   DOC_ANETAM           BIGINT,
   DOC_ANEPLA           VARCHAR(500),
   DOC_ANEDPL           VARCHAR(1),
   DOC_ANETEL           VARCHAR(1)                     not null,
   DOC_ANECOM           VARCHAR(1)                     not null,
   DOC_ANEFOT           VARCHAR(1)                     not null,
   DOC_ANEGCO           VARCHAR(1)                     not null,
   DOC_ANEGMA           BIGINT,
   DOC_ANEPDF           VARCHAR(1)                     default 'N',
   DOC_FORAJU           VARCHAR(1)                     default 'N'
);
...
create table STR_DOMIN  (
   ...
   DOM_IDENTI           VARCHAR(20)                    not null,
   DOM_TIPO             VARCHAR(1)                     not null,
   DOM_URL              VARCHAR(200),
   DOM_SQL              VARCHAR(4000),
   DOM_JNDI             VARCHAR(100),
   DOM_EJBREM           VARCHAR(1),
   DOM_EJBSTD           VARCHAR(1)                    default 'N',
   DOM_USR              VARCHAR(500),
   DOM_PWD              VARCHAR(500),
   DOM_CACHE            VARCHAR(1)                    default 'N' not null,
   DOM_CODORG           BIGINT                      not null,
   DOM_DESC             VARCHAR(100)                   not null,
   DOM_WSVER            VARCHAR(10)
);
...
create table STR_ESPNIV  (
   ...
   ETN_FLUTRA           VARCHAR(1)                    default 'N' not null,
   ETN_URLFIN          BYTEA,   
   ETN_AVISMS          BYTEA,
   ETN_AVIEMA          BYTEA,
   ETN_NOTTEL           VARCHAR(1)                    default 'N' not null,
   ETN_CHKENV          BYTEA,
   ETN_DSTTRA          BYTEA,
...
create table STR_GESFRM  (
   GSF_IDENT            VARCHAR(15)                    not null,
   GSF_DESC             VARCHAR(50)                    not null,
   GSF_URL              VARCHAR(500)                   not null,
   GSF_URLTRA           VARCHAR(500)                   not null,
   GSF_URLRED           VARCHAR(500)                   not null
);
...
create table STR_MENPLA  (
   ...
   MPL_IDENTI           VARCHAR(10)                    not null,
   MPL_ACTIVO           VARCHAR(1)                    default 'N' not null
);
...
create table STR_TRAMIT  (
   ...
   TRA_IDENTI           VARCHAR(20)                    not null,
...
create table STR_TRAVER  (
   ...
   TRV_DESTIN           VARCHAR(1)                     not null,
   TRV_PRENVA           VARCHAR(1)                    default 'N' not null,
   TRV_FIRMA            VARCHAR(1)                     not null,
   TRV_REGOFI           VARCHAR(25),
   TRV_REGAST           VARCHAR(25),
   TRV_CONEJB           VARCHAR(500),
   TRV_CONREM           VARCHAR(1)                    default 'L' not null,
   TRV_CONURL           VARCHAR(500),
   TRV_CONAUT           VARCHAR(1)                    default 'N' not null,
   TRV_CONUSU           VARCHAR(500),
   TRV_CONPWD           VARCHAR(500),
   TRV_BLOQUE           VARCHAR(1)                    default 'N' not null,
   TRV_BLOUSU           VARCHAR(1536),
   TRV_IDISOP           VARCHAR(100)                  default 'es,ca' not null,
   TRV_REDUCI           VARCHAR(1)                    default 'N' not null,
   TRV_REDFIN           VARCHAR(1)                    default 'N' not null,
   TRV_TAGCAR           VARCHAR(100),
   TRV_FECCAR           TIMESTAMP,
   TRV_ANODEF           VARCHAR(1)                    default 'N' not null,
   TRV_CONTIP           VARCHAR(1)                    default 'E' not null,
   TRV_CONWSV           VARCHAR(10)
);
...
--- V2.1.0
alter table STR_ESPNIV  add ETN_JNOCLA           VARCHAR(1)       DEFAULT 'N'     not null ;

alter table STR_ESPNIV  add ETN_JNONN            VARCHAR(1)      DEFAULT 'N'       not null ;
