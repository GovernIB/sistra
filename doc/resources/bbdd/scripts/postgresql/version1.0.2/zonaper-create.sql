...
create table ZPE_ESTEXP (
   EST_ID varchar(255) not null,
   EST_TIPO varchar(255),
   EST_CODIGO int8,
   EST_DESC varchar(255),
   EST_FECINI timestamp,
   EST_FECFIN timestamp,
   EST_ESTADO varchar(255),
   EST_AUTENT varchar(255),
   EST_USER varchar(255),
   EST_NIFRDO varchar(255),
   EST_IDIOMA varchar(255),
   EST_CODEXP varchar(255),
   EST_UNIADM int8,
   primary key (EST_ID)
);
