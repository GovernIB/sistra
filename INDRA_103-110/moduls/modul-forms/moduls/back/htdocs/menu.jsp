...
<tiles:importAttribute name="bloques" scope="page" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
    ...
    <logic:iterate id="bloque" name="bloques" >
        <tiles:insert beanName="bloque" flush="false" >
            <tiles:put name="expand" beanName="expand" />
        </tiles:insert>
    </logic:iterate>
    <tr><td>&nbsp;</td></tr>
</table>
