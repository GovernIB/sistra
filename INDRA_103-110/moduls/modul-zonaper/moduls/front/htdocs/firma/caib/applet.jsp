<object id="appfirma" name="appfirma" classid="clsid:CAFEEFAC-0015-0000-FFFF-ABCDEFFEDCBA" width="230" height="35" 
	...
	<param name="<%= es.caib.sistra.plugins.firma.impl.caib.UtilFirmaCAIB.USEALWAYSDEFAULTCONTENTTYPE_APPLET_PARAM %>" value="<%= es.caib.sistra.plugins.firma.impl.caib.UtilFirmaCAIB.isAlwaysDefaultContentTypeForSignature() %>" />
	<comment>
		...
		id="appfirma2"
		scriptable="true"
		<%= es.caib.sistra.plugins.firma.impl.caib.UtilFirmaCAIB.USEALWAYSDEFAULTCONTENTTYPE_APPLET_PARAM %>="<%= es.caib.sistra.plugins.firma.impl.caib.UtilFirmaCAIB.isAlwaysDefaultContentTypeForSignature() %>">
			<noembed>
