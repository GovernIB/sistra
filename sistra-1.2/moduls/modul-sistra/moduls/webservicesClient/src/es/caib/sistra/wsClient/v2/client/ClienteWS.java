...
public class ClienteWS {
	...
	public static ValoresDominio obtenerDominio(String url, String user, String pass, String idDominio,List parametros) throws Exception{
	   ...
	   es.caib.sistra.wsClient.v2.services.SistraFacade port = generarPort(url,user,pass);
	...
	private static es.caib.sistra.wsClient.v2.services.SistraFacade generarPort(String url,String user,String pass) throws Exception{
