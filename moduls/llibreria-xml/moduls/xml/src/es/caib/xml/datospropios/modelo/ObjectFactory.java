...
public class ObjectFactory {
    ...
    private final static QName _IDENTIFICADORSIA_QNAME = new QName("", "IDENTIFICADOR_SIA");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "IDENTIFICADOR_SIA")
    public JAXBElement<String> createIDENTIFICADORSIA(String value) {
        return new JAXBElement<String>(_IDENTIFICADORSIA_QNAME, String.class, null, value);
    }
