...
public class ConstantesAsientoXML {
	...
	/**
	 * Identificador documento de documento confirmacion registro dentro documentos tramite
	 */
	public static final String IDENTIFICADOR_CONFIRMACION_REGISTRO = "CRG";
