 ...
 */
public final class FormulariosListitemRenderer implements ListitemRenderer {
     ...
     *            Parametro idioma
     */
    public FormulariosListitemRenderer(final String pIdioma) {
        idioma = pIdioma;
    }
    ...
    public void render(final Listitem item, final Object data, int index) {
        ...
        item.appendChild(new Listcell( "Externo" ));
        
        
        
        ComponentsCtrl.applyForward(item,"onDoubleClick=onDoubleClick$itemFormulario");
    }
}
