...
public class SelectorGestorWModal extends BaseComposer {

    /**
     * Ventana.
     */
    private Window wSelectorGestor;    
   ...
   /**
     ...
     * Resultados.
     */
    private List<GestorBandeja> resultados = new ArrayList<GestorBandeja>();
    ...
    public final void doAfterCompose(final Component compEntorno) {
        ...
        try {
			resultados = DelegateUtil.getGestorBandejaDelegate().listarGestoresBandeja();
    ...
    public final void onClick$btnBuscar() {
    	...
    	try {
			resultados = resultados = DelegateUtil.getGestorBandejaDelegate().listarGestoresBandeja(filtroBusqueda.getValue());
		} catch (DelegateException e) {
			ConsolaUtil.generaDelegateException(e);
		}
    ...
    public final void onClick$btnAceptar() {
        ...
        final Event event = new Event(ConstantesZK.EVENTO_SELECCION_SELECTOR, padre,
        		new SeleccionSelector(ConstantesWEB.SELECTOR_GESTOR, value));
        Events.postEvent(event);
        
        wSelectorGestor.detach();
