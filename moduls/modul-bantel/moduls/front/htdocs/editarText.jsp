...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
   <link rel="stylesheet" href='<html:rewrite page="/estilos/estilos.css"/>' type="text/css" />
</head>
<%
...
<tr>
    <td colspan="3"><textarea readonly="true" class="detalleExt" name="ta" id="ta" cols="80" rows="40" style="width:850px;height:500px"></textarea></td>
</tr>
