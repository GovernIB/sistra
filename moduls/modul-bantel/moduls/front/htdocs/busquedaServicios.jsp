...
<head>
	<link
	 ...
	 type="text/css"
	 title="Fixed content"
	 href="<%=request.getContextPath()%>/estilos/fixed.css">
...
<body topmargin=16 marginheight=16>
    ...
    border-spacing: 2;
    margin: 10px 10px 10px 10px;"><bean:message key="notificacion.organo" /></DIV>
    
    <div id="wrapper" style="text-align: center">    
	    <div id="buscador" style="display: inline-block;">
	    	<html:form action="/buscarServicios">
				<html:hidden property="idCampo" value="<%=id%>"/>
				<html:text property="filtro" value=""/>
				<html:submit styleClass="button"><bean:message key="botons.cercar" /></html:submit>
			</html:form>
	    </div>
	</div>
		    ...
		    <table border="0" align="left" width="400px">    	
		    	...
		    	<tr>
		    		<td style="font-weight:bold;">
		    			<span class="txtBuscador"><bean:write name="nodo" property="codigo"/> - <bean:write name="nodo" property="descripcion"/></span> [<a href="javascript:seleccionar('<bean:write name="nodo" property="codigo"/>')"><bean:message key="confirmacion.seleccionar" /></a>] <br/>
		 	 		</td>
		 	 	</tr>
			 	</logic:iterate>
		 	</table>
	    ...
	    <div id="buscadorReturn" style="display: inline-block;">		 	
		 	<p>
		 		<span class="txtBuscador">
		 			<html:link action="/arbolServicios" paramId="id"><bean:message key="mensaje.volver" /></html:link>
		 		</span>
		 	</p>
	    </div>
	</div>
