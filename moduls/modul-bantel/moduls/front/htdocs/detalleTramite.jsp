										...
										<logic:notEmpty name="<%=codigoFirma %>" scope="request">
											...
											<logic:iterate name="<%=codigoFirma %>" id="firma" scope="request" type="es.caib.sistra.plugins.firma.FirmaIntf">
												...
												<a href="mostrarFirmaDocumento.do?codigo=<%=documento.getRdsCodigo()%>&clave=<%=documento.getRdsClave()%>&nif=<%=firma.getNif()%>" >
                                                    ...
                                                    <logic:empty name="firma" property="nombreApellidosRepresentante">
                                                    &nbsp; <bean:message key="firma.representadoPor"/> NIF: <bean:write name="firma" property="nifRepresentante"/>
                                                    </logic:empty>
                                                </logic:notEmpty>
												</a>
											</logic:iterate>
