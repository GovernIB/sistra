...
<logic:iterate id="nodo" name="nodosArbol" type="es.caib.bantel.front.util.NodoArbol">
	...
	<logic:notEmpty name="nodo" property="parentId">
		...
		<logic:equal name="nodo" property="seleccionable" value="true">
			<bean:write name="nodo" property="idCampo"/>.pospendHTML = '    [<i><a href="javascript:seleccionar(\'<bean:write name='nodo' property='id'/>\');"><bean:message key="confirmacion.seleccionar"/></a></i>]';
		</logic:equal>
	</logic:notEmpty>	
