...
@WebServiceClient(name = "BantelFacadeService", 
                  wsdlLocation = "WEB-INF/wsdl/v1/BantelFacade.wsdl",
...
public class BantelFacadeService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("WEB-INF/wsdl/v1/BantelFacade.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from WEB-INF/wsdl/v1/BantelFacade.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
