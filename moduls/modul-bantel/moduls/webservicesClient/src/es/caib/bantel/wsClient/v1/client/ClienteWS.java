...
public class ClienteWS {
	 ...
	 * @throws Exception
	 */
	public static void avisarEntradasWS(List entradas, String url,String soapAction, String user, String pass, boolean async) throws Exception{
		
		log.debug("Avisar Entradas por webservice v1: url=" + url);
		
		try {
			es.caib.bantel.wsClient.v1.services.BantelFacade port = generarPort(url,soapAction,user,pass);
	...
	private static es.caib.bantel.wsClient.v1.services.BantelFacade generarPort(String url,String soapAction,String user,String pass) throws Exception{
