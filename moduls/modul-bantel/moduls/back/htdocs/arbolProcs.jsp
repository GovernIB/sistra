...
<%
String idProc = request.getParameter("identificador");

String urlFuncsNodes = "/tramite/funcsNodesProcs.do";
...
{   
     opener.document.getElementsByName('<%= idProc %>').item(0).value = identificador;
...
<DIV style="TEXT-ALIGN: center;
    ...
    border-spacing: 2;
    margin: 10px 10px 10px 10px;">Procedimientos Externos</DIV> 
