...
<logic:iterate id="nodo" name="unidadesProcs" type="es.caib.bantel.back.action.tramite.NodoProcs">
	...
	<logic:notEmpty name="nodo" property="parentId">
		...
		<bean:write name="nodo" property="id"/>.pospendHTML = '    [<i><a href="javascript:seleccionar(\'<bean:write name='nodo' property='identificador'/>\');">Seleccionar</a></i>]';
