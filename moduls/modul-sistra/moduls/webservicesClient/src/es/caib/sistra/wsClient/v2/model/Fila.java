 ...
 *       &lt;sequence>
 *         &lt;element name="columna" type="{urn:es:caib:sistra:ws:v2:model:ValoresDominio}columna" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "fila", namespace = "urn:es:caib:sistra:ws:v2:model:ValoresDominio", propOrder = {
    "columna"
})
public class Fila {
