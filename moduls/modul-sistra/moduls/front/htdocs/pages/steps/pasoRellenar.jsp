...
//-->
			...
			<a href="javascript:icosMasInfo();" id="iconografiaMasInfo" title="<bean:message key="iconografia.info" />"><bean:message key="iconografia.masInfo"/></a>
				...
				<ul>
					...
					<logic:equal name="iconos" property="D" value="true">
						<li><img src="imgs/tramitacion/iconos/form_dependiente.gif" alt="<bean:message key="pasoRellenar.iconografia.formularioDependiente"/>" /> <bean:message key="pasoRellenar.iconografia.formularioDependiente"/><span><bean:message key="pasoRellenar.iconografia.formularioDependienteInfo"/> </span></li>
					</logic:equal>
			...
			<div id="listadoFormularios">
				...
				<logic:iterate id="formulario" name="tramite" property="formularios" type="es.caib.sistra.model.DocumentoFront">
					...
					<div class="iconos">
						...
						<logic:equal name="formulario" property="obligatorio" value='D'><img src="imgs/tramitacion/iconos/form_dependiente.gif" alt="<bean:message key="pasoRellenar.iconografia.formularioDependiente"/>" title="<bean:message key="pasoRellenar.iconografia.formularioDependiente"/>" /></logic:equal>
					...
					<!--  Dependiente -->
					<logic:equal name="formulario" property="obligatorio" value='D'>								
						<strong><bean:write name="formulario" property="descripcion" /></strong>
					</logic:equal>	
					<!--  Fin Dependiente -->
