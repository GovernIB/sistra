...
public class RegistroController extends FinalizacionController
{
			...
			ServletContext servletContext) throws Exception
	{
		...
		// Comprobamos si debe revisar el documento de confirmacion
		if (tramite.isGenerarDocumentoConfirmacionRegistro()) {
			// Marcamos para que pida la confirmacion
			request.setAttribute("verificarDocumentoConfirmacionRegistro","true");
		}
