...
/**
 * @struts.action
 *  path="/protected/remitirDelegacionFirma"
 *  scope="request"
 *  validate="false"
 *
 ...
 */
public class RemitirDelegacionFirmaAction extends BaseAction
{
             ...
             HttpServletResponse response) throws Exception 
     {
		 ...
		 this.setRespuestaFront( request, delegate.remitirDelegacionFirmaDocumentos() );
