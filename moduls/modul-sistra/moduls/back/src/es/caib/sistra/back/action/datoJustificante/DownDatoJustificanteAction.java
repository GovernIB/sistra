 ...
 *  scope="session"
 *  validate="false"
 *  path="/back/datoJustificante/down"
 *
 * @struts.action-forward
 *  name="success" path=".datoJustificante.lista"
 * 
 */
public class DownDatoJustificanteAction extends BaseAction
{
    protected static Log log = LogFactory.getLog(DownDatoJustificanteAction.class);
	
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
            HttpServletResponse response) throws Exception 
    {
		log.info("Entramos en DownDatoJustificanteAction");
	    ...
	    datoJustificanteDelegate.downDatoJustificante( formulario.getCodigo() );
