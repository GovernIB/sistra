...
import es.caib.sistra.back.action.TraFormBeanConfig;

public abstract class TraForm extends ValidatorForm implements InitForm 
{
protected static Log log = LogFactory.getLog(TraForm.class);
