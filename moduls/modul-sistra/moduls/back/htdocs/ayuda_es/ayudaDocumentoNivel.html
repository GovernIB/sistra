 <table width="100%" border="1">
  ...
  <tr> 
    ...
    <td>Si el documento es dependiente su dependencia se deber&aacute; indicar 
      mediante este script. El tipo de este campo es <a class="enlaceAyuda" href="../ayuda_es/ayudaScript.jsp">script</a> 
  ...
  <tr> 
    ...
    <td>Indica quien debe firmar el documento. Este campo es de tipo <a class="enlaceAyuda" href="../ayuda_es/ayudaScript.jsp">script</a> y debe
  ...
  <tr> 
    <td>Permitir guardar sin terminar</td>
    <td><p>Indica si se permite que el formulario se guarde sin terminar.</p></td>
  </tr>
  <tr> 
    <td>Script carga de datos iniciales</td>
    <td><p>Para formularios permite precargar datos en el formulario (p.ej. nif 
        y nombre del usuario). El tipo de este campo es <a class="enlaceAyuda" href="../ayuda_es/ayudaScript.jsp">script</a> 
  ...
  <tr> 
    ...
    <td>Para formularios permite realizar una validaci&oacute;n sobre los datos 
      del formulario devuelto por FORMS. El tipo de este campo es <a class="enlaceAyuda" href="../ayuda_es/ayudaScript.jsp">script</a> 
  ...
  <tr> 
    ...
    <td>Para formularios permite establecer la plantilla que debe utilizarse para 
      su visualizaci&oacute;n. El tipo de este campo es <a class="enlaceAyuda" href="../ayuda_es/ayudaScript.jsp">script</a> 
