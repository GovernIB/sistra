 <p>
  <b>Sintaxi</b><br/>
  Els scripts es codifiquen mitjançant sentències de Javascript. Dins d'aquest codi
  es podran utilitzar una sèrie de <strong>Plugins</strong> que ens permetran
  consultar dominis, obtindre valors de camps de formularis, obtindre dades
  de l'usuari, etc.</p>
<p>
  Per a retornar un resultat <b>no s'ha d'utilitzar</b> la sentència <b>return</b>, 
  sinó que cal deixar una &uacute;ltima l&iacute;nia amb la variable a retornar.<br>
  <em> Per exemple si volem retornar el resultat de la variable result, la 
  &uacute;ltima l&iacute;nia del nostre script haurà de ser:</em></p>
...
<ul>
  <li><b>Gesti&oacute; d'errors<br/>
    </b>La gesti&oacute; d'errors es realitza mitjantçant el plugin <strong>ERRORSCRIPT. 
    </strong>Mitjantçant aquest plugin indicarem si s'ha produït un 
...
<ul>
  <li><b>Acceso a missatges<br/>
    </b>Podrem accedir a missatges de validació definits en el tramit a traves del plugin <strong>PLUGIN_MENSAJES. 
    </strong>
    <br>
...
<ul>
  <li><b>Accés a dominis<br/>
    </b>Mitjantçant <strong>PLUGIN_DOMINIOS</strong> podem recuperar 
  ...
  <br/>
  <br/>
  <li><b>Accés a dades de formularis<br/>
    </b>Mitjantçant <strong>PLUGIN_FORMULARIOS</strong> podem obtindre 
    dades dels formularis. Com par&agrave;metre cal passar l'identificador 
    del document, la instància (ser&agrave; 1) i el nom del camp. .El nom del camp es construir&agrave;  a partir del XPATH de la seg&uuml;ent forma:<br />
/FORMULARIO/DATOS_PERSONALES/NOMBRE = DATOS_PERSONALES.NOMBRE<br>
    ...
    <br>
    <br>Si l'element del formulari és una <strong>llista desplegable</strong> es pot accedir al codi de l'element seleccionat de la següent forma:
    <br>
    <br>
    <em>valor = PLUGIN_FORMULARIOS.getDatoFormulario('FOR1',1,'campo1[CODIGO]');</em>
    <br/>
    <br/>
    Si el camp del formulari és <strong>multivaluat</strong> (llista desplegada, llista arbre, ...) es pot accedir al nombre de valors i a cada valor en particular de la següent forma:
    <br>
    <br/>
  ...
  <br/>
  <br/>
  <li><b> Accés a dades de la sessi&oacute;<br/>
    </b>Mitjantçant <strong>PLUGIN_DATOSSESION</strong> podem obtindre informaci&oacute; 
	...
	i es podr&agrave; accedir a les dades del delegat que realitza el tr&agrave;mit mitjançant:
	<br/>
...
<ul>
  <li><b>Accés a par&agrave;metres inici<br/>
    </b>Mitjantçant  <strong>PLUGIN_PARAMETROSINICIO</strong> podem accedir 
    a par&agrave;metres d'inici que s'indiquen en la url a l'iniciar el tr&agrave;mit. 
    <br/>
    <br/>
    Per exemple, la url para iniciar un tr&agrave;mit és: /sistrafront/init.do?language=es&amp;modelo=TRAMITE&amp;version=1<br>
    hi ha casos en els quals interesa parametritzar un tr&agrave;mit mitjantçant par&agrave;metres 
    ...
    <br>
    Aquestos par&agrave;metres són accesibles mitjantçant aquest plugin:<br>
  ...
  <li><b> Debug de script<br/>
    </b>Els scripts es poden tracejar internament mitjantçant el plugin <strong>PLUGIN_LOG</strong>. 
    <br>
    <br>
