...
<script type="text/javascript">
	...
	<!-- titol -->
	<h1 class="ajuda"><bean:message key="formularioBusqueda.backup"/></h1>
	<div id="titolOmbra"></div>
	<!-- /titol -->
	<!-- ajuda -->
	<div id="ajuda">
		<bean:message key="tabs.backup.info"/>
	</div>	
	...
	<div class="continguts">
		<!-- form reserca -->
		<html:form action="busquedaTramitesBackup" styleClass="formulari" onsubmit="return validaFormulario(this);">
			<p>
