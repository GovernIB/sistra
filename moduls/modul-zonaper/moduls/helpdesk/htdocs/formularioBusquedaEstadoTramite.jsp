...
<script type="text/javascript">
	...
	<!-- titol -->
	<h1 class="ajuda"><bean:message key="formularioBusqueda.estadoTramite"/></h1>
	<div id="titolOmbra"></div>
	<!-- /titol -->

	<!-- ajuda -->
	<div id="ajuda">
		<bean:message key="tabs.estadoTramite.info"/>
		<p><bean:message key="resultadoBusqueda.ayuda.estado"/></p>
	</div>	
	...
	<div class="continguts">
		<!-- form reserca -->
		<html:form action="busquedaEstadoTramite" styleClass="formulari" onsubmit="return validaFormulario(this);">
			<p>
