...
<script type="text/javascript">
	...
	<!-- titol -->
	<h1 class="ajuda"><bean:message key="formularioBusqueda.consultaTramitacion"/></h1>
	<div id="titolOmbra"></div>
	<!-- /titol -->
	<!-- ajuda -->
	<div id="ajuda">
		<bean:message key="tabs.consultaAuditoria.info"/>
	</div>	
	<!-- continguts -->

	<div class="continguts">
		<!-- form reserca -->
		<html:form action="consultaTramitacion" styleClass="formulari" onsubmit="return validaFormulario(this);">
			<p>
				<label for="nivelAutenticacion">
					<bean:message key="formularioBusqueda.nivelAutencicacion"/>
					<html:select property="nivelAutenticacion"  styleId="nivelAutenticacion"  onchange="formNivellAutenticacio(this.value);">
				...
				>
					...
					<html:text property="clavePersistencia"  styleId="clavePersistencia" size="50"/>
				</label>
			...
			<p>
				<label for="idioma">
					<bean:message key="formularioBusqueda.idioma"/>: 
					<html:select property="idioma">
						<html:option value="<%=Constants.TODOS%>" ><bean:message key="formularioBusqueda.idioma.todos"/></html:option>
						<html:option value="<%=Constants.CATALAN%>" ><bean:message key="formularioBusqueda.idioma.catalan"/></html:option>
						<html:option value="<%=Constants.CASTELLANO%>" ><bean:message key="formularioBusqueda.idioma.castellano"/></html:option>
					</html:select>
				</label>
			</p>
			<div id="horario"
