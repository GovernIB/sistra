...
<%@ include file="loginClientCertCustom.jsp" %>
...
<div id="contenidor">
	...
	<div id="continguts">
		...
		<div id="tramitacion">
			<br />
			<% if (esLoginClave) { %>
			<bean:message key="login.clientCert.redirigiendoClave" />
			...
			<div id="indexCD">
				<h2><bean:message key="login.clientCert.titulo" /></h2>
				<p><bean:message key="login.clientCert.instrucciones" /></p>
