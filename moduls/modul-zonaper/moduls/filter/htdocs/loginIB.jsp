...
<%@ page import="java.util.*, org.apache.struts.Globals, es.caib.util.ConvertUtil, org.apache.commons.httpclient.*, es.caib.zonaper.front.json.JSONObject, org.apache.commons.httpclient.methods.*, java.io.FileInputStream,es.caib.sistra.plugins.PluginFactory, es.caib.sistra.plugins.login.PluginLoginIntf, java.lang.reflect.Method" %>
...
<%
	...
	if (esLoginClave) {
		...
		json.put("entidad", request.getParameter("entidad"));
