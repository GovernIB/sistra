...
public interface BackofficeFacade {
    ...
    @WebResult(name = "obtenerTiquetAccesoReturn", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade")
    @RequestWrapper(localName = "obtenerTiquetAcceso", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade", className = "es.caib.zonaper.ws.v2.model.ObtenerTiquetAcceso")
    @WebMethod
    @ResponseWrapper(localName = "obtenerTiquetAccesoResponse", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade", className = "es.caib.zonaper.ws.v2.model.ObtenerTiquetAccesoResponse")
    public java.lang.String obtenerTiquetAcceso(
        @WebParam(name = "idSesionTramitacion", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade")
        java.lang.String idSesionTramitacion,
        @WebParam(name = "usuarioAutenticadoInfo", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade")
        es.caib.zonaper.ws.v2.model.UsuarioAutenticadoInfo usuarioAutenticadoInfo
