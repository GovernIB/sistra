...
public interface BackofficeFacade {
    ...
    public long obtenerTotalElementosExpediente(
        ...
        es.caib.zonaper.ws.v2.model.FiltroElementosExpediente filtroElementosExpediente
    ...
    @WebResult(name = "obtenerUrlAccesoAnonimoReturn", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade")
    @RequestWrapper(localName = "obtenerUrlAccesoAnonimo", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade", className = "es.caib.zonaper.ws.v2.model.ObtenerUrlAccesoAnonimo")
    @WebMethod
    @ResponseWrapper(localName = "obtenerUrlAccesoAnonimoResponse", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade", className = "es.caib.zonaper.ws.v2.model.ObtenerUrlAccesoAnonimoResponse")
    public java.lang.String obtenerUrlAccesoAnonimo(
        @WebParam(name = "clave", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade")
    ...
    public es.caib.zonaper.ws.v2.model.ElementosExpediente obtenerElementosExpediente(
        @WebParam(name = "filtroElementosExpediente", targetNamespace = "urn:es:caib:zonaper:ws:v2:model:BackofficeFacade")
        es.caib.zonaper.ws.v2.model.FiltroElementosExpediente filtroElementosExpediente,
