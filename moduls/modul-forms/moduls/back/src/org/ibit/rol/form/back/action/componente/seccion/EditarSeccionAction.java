package org.ibit.rol.form.back.action.componente.seccion;
...
/**
 * Action para editar un componente Seccion.
 *
 * @struts.action
 *  name="seccionForm"
 *  scope="session"
 *  validate="true"
 *  input=".seccion.editar"
 *  path="/back/seccion/editar"
 *
 * @struts.action-forward
 *  name="reload" path=".seccion.editar"
 *
 * @struts.action-forward
