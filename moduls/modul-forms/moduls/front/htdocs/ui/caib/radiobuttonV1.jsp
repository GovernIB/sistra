...
<nested:root>
	...
	<%int indexRadio=0;%>	
	<span id="<%=nombre%>@radios" class="formListado">
		<logic:iterate id="vp" name="campo" property="allValoresPosibles">    	    
	        ...
	        >
	        	<bean:write name="vp" property="traduccion.etiqueta"/>
	        </html:radio>
	    	
	    	<!--  Campo oculto con descripcion opcion -->
       		<input type="hidden" id="<%=nombre%>@textoOpcion_<%=indexRadio%>" value="<bean:write name="vp" property="traduccion.etiqueta"/>" />
    ...
    <span id="<%=nombre%>@simulaReadonly"></span>
