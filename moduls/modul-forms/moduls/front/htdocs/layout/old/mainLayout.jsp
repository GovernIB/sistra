                    ...
                    <td id="menu" align="left">
                        <div id="ayuda">
                            ...
                            <logic:present name="ayudaPantalla">
                                <br />
                                <div id="titulo"><bean:message bundle="mainMessages" key="main.help"/></div>
                                <div id="subtitulo">
                            ...
                            <logic:notEmpty name="pantallasProcesadas">
                                <br /><br />
                                <div id="titulo"><bean:message bundle="mainMessages" key="main.pantallas"/></div>
                                <div id="pantallas">
                                    <ol>
                    ...
                    <td width="203px" height="43px">
                        <div class="leyenda">
                            <logic:equal name="saveButton" value="true">
                                <a href="javascript:save()" onfocus="this.blur()" title="<bean:message bundle="mainMessages" key='boton.save'/>">
                                    <html:img alt="save" page='<%=pathIconografia + "/images/guardar.gif" %>' border="0" hspace="5"/>
                                </a>
                            </logic:equal>
                            <logic:equal name="discardButton" value="true">
                                <a href="javascript:discard()" onfocus="this.blur()" title="<bean:message bundle="mainMessages" key='boton.discard'/>">
                            ...
                            <tr>
                                <logic:equal name="backButton" value="true">
                                    <td width="50%" align="left" valign="bottom">
                                        <a href="javascript:back()" onfocus="this.blur()" title="<bean:message bundle="mainMessages" key='boton.back'/>">
                                ...
                                <logic:equal name="nextButton" value="true">
                                    <td width="50%" align="right" valign="bottom">
                                        <a href="javascript:next()" onfocus="this.blur()" title="<bean:message bundle="mainMessages" key='boton.next'/>">
                                ...
                                <logic:equal name="endButton" value="true">
                                    <td width="50%" align="right" valign="bottom">
                                        <a href="javascript:next()" onfocus="this.blur()" title="<bean:message bundle="mainMessages" key='boton.pdf'/>">
