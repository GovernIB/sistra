package es.caib.audita.front.util;
...
public class Util
{
    ...
    public static String getNumber(int numero, int numChars)
	{
		String ls_numero = String.valueOf(numero);
		String result = "";
		if(ls_numero.length()< numChars)
		{
			
			for(int i=ls_numero.length(); i<numChars; i++)
			{
				result += "0"; 
			}
		}
