...
public class WsClientSistraUtil {
	...
	public static void configurePort(BindingProvider port, String url, String soapAction,
			String user, String pass) throws Exception {
		configurePort(port, url, soapAction, user, pass, null);
	}
	 ...
	 */
	public static void configurePort(BindingProvider port, String url, String soapAction,
			String user, String pass, Integer timeoutSeconds) throws Exception {
		...
		WsClientUtil.configurePort(port, url, soapAction, user, pass, auth,
				generateTimestamp, logCalls, disableCnCheck, disableChunked, timeoutSeconds);
