 ...
 *
 * @ejb.bean
 *  name="redose/persistence/IdiomaFacade"
 *  jndi-name="es.caib.redose.persistence.IdiomaFacade"
 *  type="Stateless"
 *  view-type="remote"
...
public abstract class IdiomaFacadeEJB extends HibernateEJB {
    ...
    public List /* String */ listarLenguajes() {
        ...
        try {
            Query query = session.createQuery("select idi.codigo from Idioma as idi");
