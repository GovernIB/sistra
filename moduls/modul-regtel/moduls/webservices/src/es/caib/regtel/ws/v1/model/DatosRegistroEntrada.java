 ...
 *         &lt;element name="datosAsunto" type="{urn:es:caib:regtel:ws:v1:model:DatosAsunto}DatosAsunto"/>
...
@XmlType(name = "DatosRegistroEntrada", namespace = "urn:es:caib:regtel:ws:v1:model:DatosRegistroEntrada", propOrder = {
    "oficinaRegistral",
    "datosInteresado",
    "datosRepresentado",
    "datosAsunto",
