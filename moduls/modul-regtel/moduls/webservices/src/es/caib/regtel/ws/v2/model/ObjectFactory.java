...
public class ObjectFactory {
    ...
    private final static QName _ObtenerAcuseReciboEntidad_QNAME = new QName("urn:es:caib:regtel:ws:v2:model:BackofficeFacade", "entidad");
    ...
    private final static QName _OficinaRegistralEntidad_QNAME = new QName("", "entidad");
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:es:caib:regtel:ws:v2:model:BackofficeFacade", name = "entidad", scope = ObtenerAcuseRecibo.class)
    public JAXBElement<String> createObtenerAcuseReciboEntidad(String value) {
        return new JAXBElement<String>(_ObtenerAcuseReciboEntidad_QNAME, String.class, ObtenerAcuseRecibo.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:es:caib:regtel:ws:v2:model:BackofficeFacade", name = "entidad", scope = ObtenerDetalleAcuseRecibo.class)
    public JAXBElement<String> createObtenerDetalleAcuseReciboEntidad(String value) {
        return new JAXBElement<String>(_ObtenerAcuseReciboEntidad_QNAME, String.class, ObtenerDetalleAcuseRecibo.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "entidad", scope = OficinaRegistral.class)
    public JAXBElement<String> createOficinaRegistralEntidad(String value) {
        return new JAXBElement<String>(_OficinaRegistralEntidad_QNAME, String.class, OficinaRegistral.class, value);
    }
