 ...
 *       &lt;sequence>
 *         &lt;element name="asientoRegistral" type="{urn:es:caib:regtel:ws:v1:model:ReferenciaRDS}ReferenciaRDS"/>
 *         &lt;element name="anexos" type="{urn:es:caib:regtel:ws:v1:model:ReferenciaRDS}AnexosMap"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReferenciaRDSAsientoRegistral", namespace = "urn:es:caib:regtel:ws:v1:model:ReferenciaRDS", propOrder = {
    "asientoRegistral",
    "anexos"
})
