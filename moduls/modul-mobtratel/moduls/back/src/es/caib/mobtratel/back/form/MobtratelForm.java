...
import es.caib.mobtratel.back.action.TraFormBeanConfig;

public abstract class MobtratelForm extends ValidatorForm implements InitForm 
{
protected static Log log = LogFactory.getLog(MobtratelForm.class);
