package es.caib.mobtratel.front;
...
public class Constants implements Serializable {
     ...
     */
    public static final String DEFAULT_LANG_KEY = "es.caib.mobtratel.front.DEFAULT_LANG";
    
    public static final String DEFAULT_LANG = "ca";
    
	public static String ENVIO_KEY = "envio";
