...
@WebServiceClient(name = "BackofficeFacadeService", 
                  wsdlLocation = "WEB-INF/wsdl/v1/BackofficeFacade.wsdl",
...
public class BackofficeFacadeService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("WEB-INF/wsdl/v1/BackofficeFacade.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from WEB-INF/wsdl/v1/BackofficeFacade.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
