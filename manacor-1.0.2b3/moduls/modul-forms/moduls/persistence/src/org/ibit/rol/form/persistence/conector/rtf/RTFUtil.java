...
public class RTFUtil {
     ...
     */
    public static byte[] removeNonshppict(byte[] data) throws IOException {
     ...
     */
    public static List imagesRTF(byte[] data) throws IOException {
     ...
     */
    public static byte[] rtfImageTags(byte[] data) throws IOException {
        ...
        try {
            ...
            if (shppictPresent) {
                ...
                RTFUtil.log.error("El documento no contiene ninguna imagen");
                return data;
            }
     ...
     * @param data Datos del archivo RTF en el cual hay que sustituir las imagenes por tags
     */
    public static byte[] rtfTagsImatge(byte[] data, List images) throws IOException {
        ...
        try {
            ...
            if (tagImagesPresent) {
                ...
                RTFUtil.log.debug("El documento no contiene ningun tag imagen");
                return data;
            }
     ...
     */
    public static byte[] replace(byte[] data, String textInput, String textOutput) throws IOException {

        ByteArrayOutputStream out = new ByteArrayOutputStream(data.length);
        try {
            out.write(data);
            String document = out.toString();
            String newDocument = StringUtils.replace(document, RTFUtil.escapeRTF(textInput), RTFUtil.escapeRTF(textOutput));
            return newDocument.getBytes();
        } catch (IOException e) {
