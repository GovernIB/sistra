...
@WebServiceClient(name = "BackofficeFacadeService", 
                  wsdlLocation = "WEB-INF/wsdl/regtel/v2/BackofficeFacade.wsdl",
                  targetNamespace = "urn:es:caib:regtel:ws:v2:services") 
public class BackofficeFacadeService extends Service {

    public final static URL WSDL_LOCATION;
    public final static QName SERVICE = new QName("urn:es:caib:regtel:ws:v2:services", "BackofficeFacadeService");
    public final static QName BackofficeFacade = new QName("urn:es:caib:regtel:ws:v2:services", "BackofficeFacade");
    static {
        URL url = null;
        try {
            url = new URL("WEB-INF/wsdl/regtel/v2/BackofficeFacade.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from WEB-INF/wsdl/regtel/v2/BackofficeFacade.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
