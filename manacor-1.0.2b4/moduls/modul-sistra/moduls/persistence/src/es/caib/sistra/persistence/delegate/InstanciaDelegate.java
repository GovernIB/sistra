...
{
	void create(String tramite, int version, char nivel, Locale idioma,Map parametrosInicio) throws DelegateException;
	...
	RespuestaFront anexarDocumento(String identificador,int instancia,byte[] datosDocumento,String nomFichero,String extension,String descPersonalizada,FirmaIntf firma) throws DelegateException;;
	...
	RespuestaFront firmarFormulario(String identificador,int instancia,FirmaIntf firma) throws DelegateException; 
