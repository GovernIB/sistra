package es.caib.bantel.admin.scheduler.servlet;
 ...
 * @web.servlet-mapping url-pattern="/bantelSchedulerServlet"
 */
public class BantelSchedulerServlet implements Servlet
{
	Log _log = LogFactory.getLog( BantelSchedulerServlet.class );
		
	private static String GROUP = "Bantel";
